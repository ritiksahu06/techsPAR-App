...
const OurCredentialsPage = () => {
  const images = [
    ...
    "/images/our-credentials/auto-expo.webp",
    "/images/our-credentials/inno-rail.webp",
    "/images/our-credentials/wood-2022.webp",
    "/images/our-credentials/5th-BuildCon-Nepal_2019.webp",
    "/images/our-credentials/5thNepalWood_2019.webp",
    "/images/our-credentials/8th.webp",
    "/images/our-credentials/15th auto expo-1.webp",
    "/images/our-credentials/a-hai.webp",
    "/images/our-credentials/conmac_2018.webp",
    "/images/our-credentials/e3_2018.webp",
    "/images/our-credentials/Future_Mobility_Show_2019.webp",
    "/images/our-credentials/GES_2018.webp",
    "/images/our-credentials/iisgs_2016.webp",
    "/images/our-credentials/im-12.webp",
    "/images/our-credentials/imme-kolkatta-1.webp",
    "/images/our-credentials/imme-kolkatta-2018.webp",
    "/images/our-credentials/inno-rail-2018.webp",
    "/images/our-credentials/inno-rail-logo-1.webp",
    "/images/our-credentials/innorail.webp",
    "/images/our-credentials/IRCE_2018.webp",
    "/images/our-credentials/krushi_odisha.webp",
    "/images/our-credentials/momentum_jharkhand.webp",
    "/images/our-credentials/pack-plus-hyderabad-2016-1.webp",
    "/images/our-credentials/pama.webp",
    "/images/our-credentials/tourism.webp",
    "/images/our-credentials/toybiz2018-1.webp",
    "/images/our-credentials/momentum-jharkhand-global-investor-summit-ranchi copy.webp",
  ];
        ...
        <div className="container-fluid ">
          <div className="container">
            ...
            <div className="job-list">
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Online Registration for IMME 2018, Kolkata</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Online Registration for Sustainability Awards 2018</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Online Web Application for PARTNERSHIP SUMMIT 2018</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>IMEXPO 2017</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Online Registration for Make in India, Sweden</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>India Gaming Show South 2018</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Online Registration for Make in India Lounge Pavillion, St.
                  Petersburg International Economic Forum (SPIEF 2017), Russia
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Online Registration for IMME 2016, Kolkata</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>COMVECS 2017 - The Commercial Vehicles Show</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Incredible India Global Tourism Mart 2017</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>CII LAC Conclave, Mexico</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>1IETF India 2017</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>India Gaming Show 2017</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
            ...
            <div className="job-list mt-3">
              ...
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  5th NEPAL WOOD International Expo 2019, Nepal - Organized by
                  CII
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  5th NEPAL BUILDCON International Expo 2019, Nepal - Organized
                  by CII
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Krushi Odisha, Bhubaneswar India - Organized by CII</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  E3 – Energize Empower East" Energy Convention, Kolkata -
                  Organized by IEEMA
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  CII-ITC Sustainability Awards 2018, pravasi bharatiya kendra,
                  New Delhi - Organized by CII-ITC
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>ConMac, 2018 Kathmandu, Nepal - Organized by CII</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>INNORAIL 2018, Lucknow, UP - Organized by CII</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>IMME 2018, Kolkata - Organized by CII</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Global Exhibition on Services (GES) 2018, Mumbai –Organised by
              ...
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  IRCE 2018, Chennai –Organised by Confederation of Indian
                  Industry (CII)
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  AutoExpo Components Show 2018, New Delhi - Organized by SIAM,
                  CII & ACMA
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  PAMEX 2017, Mumbai - Organized by Printers Manufacturing
                  Association & Print Packaging.com
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  India Packaging Show 2017, Mumbai - Organized by Print
                  Packaging.com
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Industrial Maintenance Expo(IMEXPO) 2017, Pune- Organized by
                  CII
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  CII-ITC Sustainability Awards 2017, Hotel Le-Meridien, New
                  Delhi - Organized by CII-ITC
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Global Mining & Minerals Summit 2017, HEC Ground, Ranchi,
                  Jharkhand - Organized by CII
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  ...
                  Pragati Maidan, New Delhi - Organized by CII
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Sport India 2017, Pragati Maidan, New Delhi Services -
                  Organized by Indian Exhibition
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  PackPlus 2017, Pragati Maidan, New Delhi - Organized by Print
                  Packaging.com
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Toy Biz 2017 - Pragati Maidan, New Delhi - Organized by Toy
              ...
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Sign India 2017 - Pragati Maidan, New Delhi - Organized by
                  Business Live
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Oracle Open World 2017 - Pragati Maidan, New Delhi - Organized
                  by Cigma Events
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  PackPlus 2017, BIEC, Bengaluru - Organized by Print
                  Packaging.com
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Momentum Jharkhand - Global Investor Summit 2017, Ranchi -
                  Organized by CII
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>Sustainability Awards 2016 - Organized by CII- ITC</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
              ...
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>IMME 2016, Kolkata, New Delhi - Organized by CII</span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Incredible India Investor Tourism Summit 2016, Vigyan Bhawan,
                  New Delhi - Organized by CII & Ministry of Tourism, Government
                  of India
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  PackPlus 2016, Pragati Maidan, New Delhi - Organized by Print
                  Packaging.com
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Tyre Expo 2016, at Pragati Maidan - Organized by SingEx
              ...
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Global Exhibition on Services 2016, at India Expo Mart -
                  Organized by CII & SEPC, Ministry of Commerce & Industry,
                  Government of India
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  AGM at Hotel Taj Palace, New Delhi - For Confederation of
                  Indian Industry (CII)
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  Krishi Unnati Mela 2016, at PUSA GROUND - Organized by CII &
                  Ministry of Agriculture & Farmer Welfare, Government of India
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  PackPlus South 2016, HITEX, Hyderabad - Organized by Print
                  Packaging.com
                </span>
              </p>
              <p className="d-flex align-items-start">
                <i className="bi bi-check-circle-fill text-primary me-2"></i>
                <span>
                  PAMEX 2015, BEC, Mumbai - Organized by All India Federation of
                  Master Printers (AIFMP) & Print Packaging.com and Many More
                  Events in past….
                </span>
              </p>
            </div>
